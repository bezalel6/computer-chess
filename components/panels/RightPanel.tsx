...
export function RightPanel({ onFindMatch, onChallengeUser }: RightPanelProps) {
  ...
  const myUsername = session?.user?.name || 'Guest';
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-2">
        ...
        />
        <span className={`font-medium ${isCurrentPlayer ? 'text-blue-500' : ''}`}>
          {username}
        </span>
      </div>
